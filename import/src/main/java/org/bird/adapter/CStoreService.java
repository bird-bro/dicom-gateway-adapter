...
import org.bird.adapter.cstore.DicomStreamUtils;
...
import org.bird.adapter.cstore.monitoring.Event;
import org.bird.adapter.cstore.multipledest.IMultipleDestinationUploadService;
import org.bird.adapter.cstore.multipledest.IMultipleDestinationUploadService.MultipleDestinationUploadServiceException;
...
public class CStoreService extends BasicCStoreSCP {
    ...
    protected void store(Association association, PresentationContext presentationContext, Attributes request,
        ...
        try {
            ...
            try (InputStream inWithHeader = DicomStreamUtils.dicomStreamWithFileMetaHeader(sopInstanceUID, sopClassUID, transferSyntax, countingStream)){
