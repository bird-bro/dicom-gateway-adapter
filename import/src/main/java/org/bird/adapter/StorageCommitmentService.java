    ...
    protected void onDimseRQ(Association as, PresentationContext pc, Dimse dimse, Attributes cmd, Attributes data) throws IOException {
        try {
            ...
            if (remoteAet == null) {
                ...
                throw new DicomServiceException(Status.ProcessingFailure, "Unknown AET: " + as.getRemoteAET());
            }

            CommitmentReportTask task = new CommitmentReportTask(as.getApplicationEntity(), data, remoteAet);
    ...
    private class CommitmentReportTask implements Runnable {
        ...
        public void run() {
            ...
            for (Attributes attrsItem : sopSequence) {
                ...
                try {
                    String qidoPath = AttributesUtils.attributesToQidoPath(queryAttributes);
                ...
                } catch (DicomServiceException | IGatewayClient.DicomGatewayException e) {
        ...
        private int toFailureReason(Exception e) {
            if (e instanceof IGatewayClient.DicomGatewayException) {
                IGatewayClient.DicomGatewayException webException = (IGatewayClient.DicomGatewayException) e;
